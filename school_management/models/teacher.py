...
class Teacher(BaseModel):
    ...
    first_name = models.CharField(
        _('First Name'),
        help_text=_('First Name of teacher'),
        max_length=255)
    
    last_name = models.CharField(
        _('Last Name'),
        help_text=_('Last Name of teacher'),
        max_length=255,
    ...
    email = models.EmailField(
        ...
        help_text=_("Official Email address of teacher")
    )
    school = models.ForeignKey(
        "School",verbose_name="Linked School",
        related_name="teachers",on_delete=models.SET_NULL,
        blank=True,null=True)
